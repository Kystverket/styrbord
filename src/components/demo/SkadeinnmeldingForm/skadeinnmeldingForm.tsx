        ...
        <Box width="form" p={16}>
          <div className={classes.formArea}>
            <FormSection>
              ...
              <Fieldset>
                ...
                <Radio
                  ...
                  onChange={() =>
                    onChange?.({ ...data, skade: { ...data?.skade, alvorlighetsgrad: 'fareForPersoner' } })
                  }
                />
                <Radio
                ...
                <Radio
                  ...
                  onChange={() =>
                    onChange?.({ ...data, skade: { ...data?.skade, alvorlighetsgrad: 'nedsattFunksjon' } })
                  }
                />
                <Radio
            ...
            <FormSection
              ...
              description="Angi kontaktinformasjon hvis vi trenger å kontakte deg."
            >
              <TextInput
                label="Navn"
