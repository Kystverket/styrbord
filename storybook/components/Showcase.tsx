  ...
  return (
    <div className={cl(classes.components, className)} {...props}>
      ...
      <div className={cl(classes.card, classes.user)}>
        <Heading className={cl(classes.cardTitle, classes.userTitle)}>Opprett ny bruker</Heading>
        <Textfield label="Navn" placeholder="Ola Normann" className={classes.userField} />
        <Textfield type="email" label="E-post" placeholder="ola@norge.no" className={classes.userField} />
        <Tooltip content="Trykk for å få hjelp">
          <Link href="#" className={classes.userLink}>
            Glemt passord?
          </Link>
        </Tooltip>
        <Button variant="filled" className={classes.userBtn}>
          Opprett ny bruker
        </Button>
      </div>
      ...
      <div className={cl(classes.card, classes.radio)}>
        <Fieldset>
          ...
          <Radio name="iskremsmak" label="Jordbær" value="jordbær" defaultChecked />
          <Radio name="iskremsmak" label="Sjokolade" value="sjokolade" />
          <Radio name="iskremsmak" label="Jeg spiser ikke iskrem" value="spiser-ikke-is" />
        </Fieldset>
      </div>
      ...
      <div className={cl(classes.card, classes.switches)}>
        <Heading style={{ marginBottom: 'var(--ds-size-2)' }}>Innstillinger</Heading>
        <Paragraph style={{ marginBottom: 'var(--ds-size-2)' }}>Her kan du justere på innstillingene dine</Paragraph>
      ...
      <div className={cl(classes.card, classes.combobox)}>
        <Heading style={{ marginBottom: 'var(--ds-size-2)' }}>Hvor er du fra?</Heading>
        <Paragraph style={{ marginBottom: 'var(--ds-size-2)' }}>Svar under så finner vi flyreise</Paragraph>
      ...
      <div className={cl(classes.card, classes.tabs)}>
        ...
        <Paragraph>
          ...
          , må organisasjonen drive frivillig virksomhet. Det er bare foreninger,{' '}
          <Link href="#" data-color="neutral">
            stiftelser
          </Link>{' '}
          og som kan registreres. Virksomheten kan ikke dele ut midler til fysiske personer. Virksomheten må ha et
