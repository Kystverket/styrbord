...
export const Checkbox: StoryFn<typeof Chip.Checkbox> = (args) => <Chip.Checkbox {...args}>Nynorsk</Chip.Checkbox>;

export const Removable: StoryFn<typeof Chip.Removable> = (args) => <Chip.Removable {...args}>Norge</Chip.Removable>;
