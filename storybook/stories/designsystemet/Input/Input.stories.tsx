...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: '[Dokumentasjon fra Designsystemet](https://designsystemet.no/no/components/textfield)',
      },
    },
  },
} as Meta;
  ...
  return (
    <>
      ...
      <div>
        ...
        <Paragraph style={{ margin: 'var(--ds-size-2) 0' }}>Du har skrevet inn: {value}</Paragraph>
  ...
  return (
    <div>
      {sizes.map((size) => (
        ...
        >
          <Heading data-size="2xs" style={{ gridColumn: '1 / -1', marginTop: 16 }}>
            {sizenames[size]}
          </Heading>
          {states.map((state) => (
            <Field key={state.label}>
