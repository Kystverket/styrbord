...
import BaatfartMarine from './svg/baatfart_marine.svg?react';
import BestilleLos from './svg/bestille_los.svg?react';
import Boelgevarsel from './svg/boelgevarsel.svg?react';
...
import DigitaleFyrbesoek from './svg/digitale_fyrbesoek.svg?react';
...
import Kystvaer from './svg/kystvaer.svg?react';
import ForespoerselSendt from './svg/illustrert_forespoersel_sendt.svg?react';
...
import SkadePaaInfrastruktur from './svg/skade_paa_infrastruktur.svg?react';
import SkadePaaInfrastrukturFarget from './svg/skade_paa_infrastruktur_farget.svg?react';
