import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{a6 as a,B,I as E,a7 as r,a8 as M,a9 as O,P as _,aa as n}from"./idContext-CKUvFBkh.js";import"./Details-DvfWqSLU.js";import"./kyvDivider-GkhM6YIE.js";import"./typography-CdiQYpGP.js";import"./skillingsbuoye-BG85ofhS.js";import"./Logo-DajRw6N7.js";import{r as D}from"./iframe-DVSGA_Gm.js";import{u as T}from"./use-checkbox-group-DT_vWW57.js";import{C as Se}from"./index-bomVjenZ.js";import{u as Ie,P as u}from"./index-DgowgosW.js";import"./index-DFftnHBT.js";import"./index-BXUDGTIn.js";import"./index-BFs9OknO.js";import"./lite-DaUVFjkg.js";import"./index-t63ITii6.js";import"./label-C8KeqmTJ.js";import"./heading-CZQmcGqV.js";import"./index-Bsl9iDld.js";import"./preload-helper-Dp1pzeXC.js";const qe={title:"Form/Checkbox",component:a,tags:["autodocs","ds-override"],parameters:{docs:{description:{component:"[Dokumentasjon fra Designsystemet](https://designsystemet.no/no/components/docs/checkbox/overview)"}}}},x={args:{label:"Checkbox label",description:"Description",disabled:!1,readOnly:!1,value:"value"}},F={args:{value:"value","aria-label":"Checkbox"}},d=c=>{const{getCheckboxProps:s,validationMessageProps:t}=T({value:["epost"],...c});return e.jsxs(r,{children:[e.jsx(r.Legend,{children:"Hvordan vil du helst at vi skal kontakte deg?"}),e.jsx(r.Description,{children:"Velg alle alternativene som er relevante for deg."}),e.jsx(a,{label:"E-post",...s("epost")}),e.jsx(a,{label:"Telefon",...s("telefon")}),e.jsx(a,{label:"SMS",...s("sms")}),e.jsx(M,{...t})]})};d.args={name:"my-group",disabled:!1,error:""};const v=()=>e.jsxs(r,{children:[e.jsx(r.Legend,{children:"Bekreft at du er over 18 år"}),e.jsx(r.Description,{children:"For at vi skal kunne sende deg opplysningen du ber om, må du bekrefte at du er myndig."}),e.jsx(a,{label:"Jeg bekrefter at jeg er over 18 år",value:"samtykke"})]}),S={render:d,args:{...d.args,name:"my-error",error:"Du må velge minst to kontaktalternativ"}},h=(c,s)=>{const t={barnehage:{label:"Barnehage"},grunnskole:{label:"Grunnskole"},videregaende:{label:"Videregående"}},{getCheckboxProps:i,validationMessageProps:b,value:g,setValue:m}=T({name:"my-controlled",value:["barnehage","videregaende"],...c}),L=(o,p)=>o.includes(p)?o.filter(Fe=>Fe!==p):o.concat(p),l=g.length>0;return e.jsxs(e.Fragment,{children:[e.jsxs(r,{children:[e.jsx(r.Legend,{children:"Utdanningsnivå"}),Object.entries(t).map(([o,{label:p}])=>e.jsx(a,{id:`${s.id}-${o}`,label:p,...i(o)},o))]}),e.jsx(M,{...b}),e.jsx(O,{}),e.jsx(_,{children:"(Annet innhold)"}),e.jsx(O,{}),e.jsxs("div",{style:{display:"flex",gap:"var(--ds-size-2)"},children:[e.jsx(_,{children:l?"Viser innhold for:":"Viser alt innhold"}),l&&g.map(o=>e.jsx(Se.Removable,{"aria-label":`Slett ${t[o].label}`,onClick:()=>m(L(g,o)),children:t[o].label},o))]}),l&&e.jsx(B,{style:{width:"fit-content"},variant:"outline",onClick:()=>m([]),children:"Tøm filtre"})]})};h.parameters={layout:"padded",customStyles:{display:"flex",gap:"var(--ds-size-4)",flexDirection:"column"}};const I={args:{...d.args,name:"my-readonly",readOnly:!0},render:d},H={args:{...x.args,name:"my-disabled",disabled:!0},render:d},w=[{id:1,navn:"Lise Nordmann",epost:"lise@nordmann.no",telefon:"68051156"},{id:2,navn:"Kari Nordmann",epost:"kari@nordmann.no",telefon:"68059679"},{id:3,navn:"Ola Nordmann",epost:"ola@nordmann.no",telefon:"68055731"},{id:4,navn:"Per Nordmann",epost:"per@nordmann.no",telefon:"68059631"}],C=(c,s)=>{const{getCheckboxProps:t}=T({name:s.id,value:["2","3"],...c});return e.jsxs(n,{children:[e.jsxs("colgroup",{children:[e.jsx("col",{style:{width:"1px"}}),e.jsx("col",{}),e.jsx("col",{})]}),e.jsx(n.Head,{children:e.jsxs(n.Row,{children:[e.jsx(n.HeaderCell,{children:e.jsx(a,{"aria-label":"Velg alle",...t({allowIndeterminate:!0,value:"all"})})}),e.jsx(n.HeaderCell,{children:"Navn"}),e.jsx(n.HeaderCell,{children:"E-post"})]})}),e.jsx(n.Body,{children:w.map(i=>e.jsxs(n.Row,{children:[e.jsx(n.Cell,{children:e.jsx(a,{"aria-labelledby":`${s.id}-${i.id}-name`,...t(i.id.toString())})}),e.jsx(n.Cell,{id:`${s.id}-${i.id}-name`,children:i.navn}),e.jsx(n.Cell,{children:i.epost})]},i.id))})]})},k=c=>{const{getCheckboxProps:s,validationMessageProps:t,value:i}=T({value:["epost"],...c}),[b,g]=D.useState(!1);return e.jsxs(e.Fragment,{children:["Dine kommunikasjonskanaler: ",i.join(", "),b?e.jsxs(e.Fragment,{children:[e.jsxs(B,{onClick:()=>g(!1),children:[e.jsx(E,{material:"download","aria-hidden":!0})," Lagre"]}),e.jsxs(r,{children:[e.jsx(r.Legend,{children:"Hvordan vil du helst at vi skal kontakte deg?"}),e.jsx(r.Description,{children:"Velg alle alternativene som er relevante for deg."}),e.jsx(a,{label:"E-post",...s("epost")}),e.jsx(a,{label:"Telefon",...s("telefon")}),e.jsx(a,{label:"SMS",...s("sms")}),e.jsx(M,{...t})]})]}):e.jsxs(B,{onClick:()=>g(!0),variant:"outline",children:[e.jsx(E,{material:"edit","aria-hidden":!0})," Rediger"]})]})},j=c=>{const[t,i]=D.useState(1),{getCheckboxProps:b}=T({...c}),g=Math.ceil(w.length/3),m=Ie({currentPage:t,setCurrentPage:i,totalPages:g,showPages:g}),L=D.useMemo(()=>{const l=(t-1)*3;return w.slice(l,l+3)},[t]);return e.jsxs("div",{children:[e.jsxs(n,{children:[e.jsx(n.Head,{children:e.jsxs(n.Row,{children:[e.jsx(n.HeaderCell,{children:e.jsx(a,{"aria-label":"Select all",...b({allowIndeterminate:!0,value:"all"})})}),e.jsx(n.HeaderCell,{children:"Navn"}),e.jsx(n.HeaderCell,{children:"Epost"}),e.jsx(n.HeaderCell,{children:"Telefon"})]})}),e.jsx(n.Body,{children:L.map(l=>e.jsxs(n.Row,{children:[e.jsx(n.Cell,{children:e.jsx(a,{"aria-label":"Check "+l.id,...b({value:l.id.toString()})})}),e.jsx(n.Cell,{children:l.navn}),e.jsx(n.Cell,{children:l.epost}),e.jsx(n.Cell,{children:l.telefon})]},l.id))})]}),e.jsx(u,{children:e.jsxs(u.List,{children:[e.jsx(u.Item,{children:e.jsx(u.Button,{...m.prevButtonProps,children:"Forrige"})}),m.pages.map(({itemKey:l,buttonProps:o,page:p})=>e.jsx(u.Item,{children:typeof p=="number"&&e.jsx(u.Button,{...o,"aria-label":`Side ${p}`,children:p})},l)),e.jsx(u.Item,{children:e.jsx(u.Button,{...m.nextButtonProps,children:"Neste"})})]})})]})},P=()=>e.jsxs(r,{children:[e.jsx(r.Legend,{children:"Hvor lenge har du jobbet i det offentlige?"}),e.jsx(a,{label:"I under ett år",value:"0-3"}),e.jsx(a,{label:"Fra 1-3 år",value:"1-3"}),e.jsx(a,{label:"Mer enn 3 år",value:"3+"})]}),f=()=>e.jsxs(r,{children:[e.jsx(r.Legend,{children:"Hva liker du best med jobben din?"}),e.jsx(a,{label:"Jeg liker å jobbe med selvstendige oppgaver",value:"selvstendige"}),e.jsx(a,{label:"Jeg elsker møter",value:"moter"}),e.jsx(a,{label:"Lunsjen er best",value:"lunsj"}),e.jsx(a,{label:"Jeg liker å møte kolleger",value:"kolleger"})]}),y=()=>e.jsxs(r,{children:[e.jsx(r.Legend,{children:"Hva liker du best med jobben din?"}),e.jsx(a,{label:"Selvstendige oppgaver",value:"selvstendige"}),e.jsx(a,{label:"Møter",value:"moter"}),e.jsx(a,{label:"Lunsj",value:"lunsj"}),e.jsx(a,{label:"Kolleger",value:"kolleger"})]});d.__docgenInfo={description:"",methods:[],displayName:"Group"};v.__docgenInfo={description:"",methods:[],displayName:"OneOption"};h.__docgenInfo={description:"",methods:[],displayName:"Controlled"};C.__docgenInfo={description:"",methods:[],displayName:"InTable"};k.__docgenInfo={description:"",methods:[],displayName:"Conditional"};j.__docgenInfo={description:"",methods:[],displayName:"InTableWithPagination"};P.__docgenInfo={description:"",methods:[],displayName:"ContentEx1"};f.__docgenInfo={description:"",methods:[],displayName:"ContentEx2"};y.__docgenInfo={description:"",methods:[],displayName:"ContentEx3"};var R,V,N;x.parameters={...x.parameters,docs:{...(R=x.parameters)==null?void 0:R.docs,source:{originalSource:`{
  ...
  </Fieldset>`,...(Te=(ye=y.parameters)==null?void 0:ye.docs)==null?void 0:Te.source}}};const Qe=["Preview","AriaLabel","Group","OneOption","WithError","Controlled","ReadOnly","Disabled","InTable","Conditional","InTableWithPagination","ContentEx1","ContentEx2","ContentEx3"];export{F as AriaLabel,k as Conditional,P as ContentEx1,f as ContentEx2,y as ContentEx3,h as Controlled,H as Disabled,d as Group,C as InTable,j as InTableWithPagination,v as OneOption,x as Preview,I as ReadOnly,S as WithError,Qe as __namedExportsOrder,qe as default};
