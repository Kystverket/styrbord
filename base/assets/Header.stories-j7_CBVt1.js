import{S as nr,j as e}from"./iframe-WKIRg0XG.js";import{H as ar,A as er}from"./Dialog-D4qjwnD9.js";import"./preload-helper-Dp1pzeXC.js";import"./tooltip-Cb0cksK0.js";import"./index-BprNiIUZ.js";import"./index-B46LPQkM.js";import"./shipTypes-hFnSBndP.js";import"./Details-CRHO2nlV.js";import"./KyvDivider-L4aYN3Mp.js";import"./typography-DVDzzXfp.js";import"./KyvSpinner-DMTidkHX.js";import"./skillingsbuoye-DkUwV7IG.js";import"./Logo-DF4wfcVh.js";import"./color-tokens-DRys5hYJ.js";const br={title:"Page/Header",component:ar,decorators:[nr],tags:["autodocs","kyv"],argTypes:{logo:{control:{type:"object"}}}},or={logo:{variant:"saksbehandling",url:"/"},applications:[{id:"sak",name:"Saksbehandling",icon:"data_table"},{id:"is",name:"Ismelding",icon:"severe_cold"},{id:"hoer",name:"Høring",icon:"export_notes"},{id:"dev",name:"Utvikling",icon:"anchor"}],links:[{applicationId:"sak",position:"main",label:"Arbeidsliste",url:"#"},{applicationId:"sak",position:"main",label:"Alle saker",url:"#"},{applicationId:"dev",position:"main",label:"Innsendinger",url:"#"},{applicationId:"dev",position:"main",label:"Tilbakemeldinger",url:"#"},{applicationId:"hoer",position:"main",label:"Høring",url:"#"},{applicationId:"is",position:"main",label:"Ismelding",url:"#"},{position:"main",label:"Saksbehandlere",url:"#"},{position:"profile",icon:"person",label:"Min side",url:"#"}],profile:{name:"Ola Nordmann",department:"Hav- og kystforvaltning"},logoutHandler:()=>alert("Logger ut")},n={args:or,decorators:[o=>e.jsx("div",{style:{marginBottom:"150px"},children:e.jsx(er.Provider,{value:{applicationId:"sak"},children:e.jsx(o,{})})})]},a={args:or,decorators:[o=>e.jsx("div",{style:{marginBottom:"150px"},children:e.jsx(er.Provider,{value:{applicationId:"dev"},children:e.jsx(o,{})})})]},r={logo:{variant:"blue-horizontal",url:"#"}},t={args:{...r,logo:{...r.logo,variant:"blue-horizontal"}}},s={args:{...r,logo:{...r.logo,title:"Styrbord"}}},l={args:{...r,logo:{...r.logo,variant:"datakatalog"}}},i={args:{...r,logo:{...r.logo,variant:"fyr"}}},d={args:{...r,logo:{...r.logo,variant:"hais"}}},p={args:{...r,logo:{...r.logo,variant:"pfsa"}}},c={args:{...r,logo:{...r.logo,variant:"selvbetjening"}}},g={args:{...r,links:[{icon:"anchor",label:"Kystverket",url:"https://kystverket.no"},{icon:"settings",label:"Settings",url:"#"}],profile:{name:"Ola Nordmann",department:"Hav- og kystforvaltning"},logoutHandler:()=>alert("Logger ut")},decorators:[o=>e.jsx("div",{style:{marginBottom:"300px"},children:e.jsx(o,{})})]},m={args:{...r,links:[{icon:"anchor",label:"Kystverket",url:"https://kystverket.no"},{icon:"settings",label:"Settings",url:"#"}],logoutHandler:()=>alert("Logger ut")}},u={args:{...r,profile:{name:"Ola Nordmann",department:"Hav- og kystforvaltning"}},decorators:[o=>e.jsx("div",{style:{marginBottom:"150px"},children:e.jsx(o,{})})]},v={args:{...r,links:[...r.links||[],{position:"profile",icon:"anchor",label:"Kystverket",url:"https://kystverket.no"},{position:"profile",icon:"settings",label:"Settings",url:"#"}],profile:{name:"Ola Nordmann"},logoutHandler:()=>alert("Logger ut")},decorators:[o=>e.jsx("div",{style:{marginBottom:"300px"},children:e.jsx(o,{})})]};var k,y,f;n.parameters={...n.parameters,docs:{...(k=n.parameters)==null?void 0:k.docs,source:{originalSource:`{
...
}`,...(A=(I=s.parameters)==null?void 0:I.docs)==null?void 0:A.source}}};var B,M,O;l.parameters={...l.parameters,docs:{...(B=l.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    logo: {
      ...defaultProps.logo,
...
}`,...(O=(M=l.parameters)==null?void 0:M.docs)==null?void 0:O.source}}};var L,K,N;i.parameters={...i.parameters,docs:{...(L=i.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    logo: {
      ...defaultProps.logo,
...
}`,...(N=(K=i.parameters)==null?void 0:K.docs)==null?void 0:N.source}}};var C,_,z;d.parameters={...d.parameters,docs:{...(C=d.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    logo: {
      ...defaultProps.logo,
...
}`,...(rr=($=v.parameters)==null?void 0:$.docs)==null?void 0:rr.source}}};const Sr=["Saksbehandling","SaksbehandlingAnnenApplikasjon","Kystverket","MedUndertittel","Datakatalog","Fyr","Hais","Pfsa","Selvbetjening","medProfilOgMenyItems","medMenyItems","medProfil","medProfilLenker"];export{l as Datakatalog,i as Fyr,d as Hais,t as Kystverket,s as MedUndertittel,p as Pfsa,n as Saksbehandling,a as SaksbehandlingAnnenApplikasjon,c as Selvbetjening,Sr as __namedExportsOrder,br as default,m as medMenyItems,u as medProfil,v as medProfilLenker,g as medProfilOgMenyItems};
