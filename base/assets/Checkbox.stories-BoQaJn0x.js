import{r as D,j as e}from"./iframe-Czv3AHya.js";import{B,I as E,a8 as n}from"./SlotDialog-DWY9LpQH.js";import"./Details-32TxQ_PH.js";import"./kyvDivider-BCRc_Uf9.js";import"./typography-hnOE2O5i.js";import"./skillingsbuoye-CCNtNPj1.js";import"./Logo-C52OS84m.js";import{C as a,F as l,V as M,D as O,P as V,a as Se,b as u}from"./tooltip-DjKviRXa.js";import{u as T}from"./use-checkbox-group-BY00IGlT.js";import{u as Ie}from"./use-pagination-u13dOQia.js";import"./preload-helper-Dp1pzeXC.js";import"./index-D1vxHnYL.js";import"./index-BU31YQ6P.js";const $e={title:"Form/Checkbox",component:a,tags:["autodocs","ds-override"],parameters:{docs:{description:{component:"[Dokumentasjon fra Designsystemet](https://designsystemet.no/no/components/docs/checkbox/overview)"}}}},x={args:{label:"Checkbox label",description:"Description",disabled:!1,readOnly:!1,value:"value"}},F={args:{value:"value","aria-label":"Checkbox"}},d=c=>{const{getCheckboxProps:s,validationMessageProps:t}=T({value:["epost"],...c});return e.jsxs(l,{children:[e.jsx(l.Legend,{children:"Hvordan vil du helst at vi skal kontakte deg?"}),e.jsx(l.Description,{children:"Velg alle alternativene som er relevante for deg."}),e.jsx(a,{label:"E-post",...s("epost")}),e.jsx(a,{label:"Telefon",...s("telefon")}),e.jsx(a,{label:"SMS",...s("sms")}),e.jsx(M,{...t})]})};d.args={name:"my-group",disabled:!1,error:""};const v=()=>e.jsxs(l,{children:[e.jsx(l.Legend,{children:"Bekreft at du er over 18 år"}),e.jsx(l.Description,{children:"For at vi skal kunne sende deg opplysningen du ber om, må du bekrefte at du er myndig."}),e.jsx(a,{label:"Jeg bekrefter at jeg er over 18 år",value:"samtykke"})]}),S={render:d,args:{...d.args,name:"my-error",error:"Du må velge minst to kontaktalternativ"}},h=(c,s)=>{const t={barnehage:{label:"Barnehage"},grunnskole:{label:"Grunnskole"},videregaende:{label:"Videregående"}},{getCheckboxProps:i,validationMessageProps:b,value:g,setValue:m}=T({name:"my-controlled",value:["barnehage","videregaende"],...c}),L=(o,p)=>o.includes(p)?o.filter(Fe=>Fe!==p):o.concat(p),r=g.length>0;return e.jsxs(e.Fragment,{children:[e.jsxs(l,{children:[e.jsx(l.Legend,{children:"Utdanningsnivå"}),Object.entries(t).map(([o,{label:p}])=>e.jsx(a,{id:`${s.id}-${o}`,label:p,...i(o)},o))]}),e.jsx(M,{...b}),e.jsx(O,{}),e.jsx(V,{children:"(Annet innhold)"}),e.jsx(O,{}),e.jsxs("div",{style:{display:"flex",gap:"var(--ds-size-2)"},children:[e.jsx(V,{children:r?"Viser innhold for:":"Viser alt innhold"}),r&&g.map(o=>e.jsx(Se.Removable,{"aria-label":`Slett ${t[o].label}`,onClick:()=>m(L(g,o)),children:t[o].label},o))]}),r&&e.jsx(B,{style:{width:"fit-content"},variant:"outline",onClick:()=>m([]),children:"Tøm filtre"})]})};h.parameters={layout:"padded",customStyles:{display:"flex",gap:"var(--ds-size-4)",flexDirection:"column"}};const I={args:{...d.args,name:"my-readonly",readOnly:!0},render:d},H={args:{...x.args,name:"my-disabled",disabled:!0},render:d},w=[{id:1,navn:"Lise Nordmann",epost:"lise@nordmann.no",telefon:"68051156"},{id:2,navn:"Kari Nordmann",epost:"kari@nordmann.no",telefon:"68059679"},{id:3,navn:"Ola Nordmann",epost:"ola@nordmann.no",telefon:"68055731"},{id:4,navn:"Per Nordmann",epost:"per@nordmann.no",telefon:"68059631"}],C=(c,s)=>{const{getCheckboxProps:t}=T({name:s.id,value:["2","3"],...c});return e.jsxs(n,{children:[e.jsxs("colgroup",{children:[e.jsx("col",{style:{width:"1px"}}),e.jsx("col",{}),e.jsx("col",{})]}),e.jsx(n.Head,{children:e.jsxs(n.Row,{children:[e.jsx(n.HeaderCell,{children:e.jsx(a,{"aria-label":"Velg alle",...t({allowIndeterminate:!0,value:"all"})})}),e.jsx(n.HeaderCell,{children:"Navn"}),e.jsx(n.HeaderCell,{children:"E-post"})]})}),e.jsx(n.Body,{children:w.map(i=>e.jsxs(n.Row,{children:[e.jsx(n.Cell,{children:e.jsx(a,{"aria-labelledby":`${s.id}-${i.id}-name`,...t(i.id.toString())})}),e.jsx(n.Cell,{id:`${s.id}-${i.id}-name`,children:i.navn}),e.jsx(n.Cell,{children:i.epost})]},i.id))})]})},k=c=>{const{getCheckboxProps:s,validationMessageProps:t,value:i}=T({value:["epost"],...c}),[b,g]=D.useState(!1);return e.jsxs(e.Fragment,{children:["Dine kommunikasjonskanaler: ",i.join(", "),b?e.jsxs(e.Fragment,{children:[e.jsxs(B,{onClick:()=>g(!1),children:[e.jsx(E,{material:"download","aria-hidden":!0})," Lagre"]}),e.jsxs(l,{children:[e.jsx(l.Legend,{children:"Hvordan vil du helst at vi skal kontakte deg?"}),e.jsx(l.Description,{children:"Velg alle alternativene som er relevante for deg."}),e.jsx(a,{label:"E-post",...s("epost")}),e.jsx(a,{label:"Telefon",...s("telefon")}),e.jsx(a,{label:"SMS",...s("sms")}),e.jsx(M,{...t})]})]}):e.jsxs(B,{onClick:()=>g(!0),variant:"outline",children:[e.jsx(E,{material:"edit","aria-hidden":!0})," Rediger"]})]})},j=c=>{const[t,i]=D.useState(1),{getCheckboxProps:b}=T({...c}),g=Math.ceil(w.length/3),m=Ie({currentPage:t,setCurrentPage:i,totalPages:g,showPages:g}),L=D.useMemo(()=>{const r=(t-1)*3;return w.slice(r,r+3)},[t]);return e.jsxs("div",{children:[e.jsxs(n,{children:[e.jsx(n.Head,{children:e.jsxs(n.Row,{children:[e.jsx(n.HeaderCell,{children:e.jsx(a,{"aria-label":"Select all",...b({allowIndeterminate:!0,value:"all"})})}),e.jsx(n.HeaderCell,{children:"Navn"}),e.jsx(n.HeaderCell,{children:"Epost"}),e.jsx(n.HeaderCell,{children:"Telefon"})]})}),e.jsx(n.Body,{children:L.map(r=>e.jsxs(n.Row,{children:[e.jsx(n.Cell,{children:e.jsx(a,{"aria-label":"Check "+r.id,...b({value:r.id.toString()})})}),e.jsx(n.Cell,{children:r.navn}),e.jsx(n.Cell,{children:r.epost}),e.jsx(n.Cell,{children:r.telefon})]},r.id))})]}),e.jsx(u,{children:e.jsxs(u.List,{children:[e.jsx(u.Item,{children:e.jsx(u.Button,{...m.prevButtonProps,children:"Forrige"})}),m.pages.map(({itemKey:r,buttonProps:o,page:p})=>e.jsx(u.Item,{children:typeof p=="number"&&e.jsx(u.Button,{...o,"aria-label":`Side ${p}`,children:p})},r)),e.jsx(u.Item,{children:e.jsx(u.Button,{...m.nextButtonProps,children:"Neste"})})]})})]})},P=()=>e.jsxs(l,{children:[e.jsx(l.Legend,{children:"Hvor lenge har du jobbet i det offentlige?"}),e.jsx(a,{label:"I under ett år",value:"0-3"}),e.jsx(a,{label:"Fra 1-3 år",value:"1-3"}),e.jsx(a,{label:"Mer enn 3 år",value:"3+"})]}),f=()=>e.jsxs(l,{children:[e.jsx(l.Legend,{children:"Hva liker du best med jobben din?"}),e.jsx(a,{label:"Jeg liker å jobbe med selvstendige oppgaver",value:"selvstendige"}),e.jsx(a,{label:"Jeg elsker møter",value:"moter"}),e.jsx(a,{label:"Lunsjen er best",value:"lunsj"}),e.jsx(a,{label:"Jeg liker å møte kolleger",value:"kolleger"})]}),y=()=>e.jsxs(l,{children:[e.jsx(l.Legend,{children:"Hva liker du best med jobben din?"}),e.jsx(a,{label:"Selvstendige oppgaver",value:"selvstendige"}),e.jsx(a,{label:"Møter",value:"moter"}),e.jsx(a,{label:"Lunsj",value:"lunsj"}),e.jsx(a,{label:"Kolleger",value:"kolleger"})]});d.__docgenInfo={description:"",methods:[],displayName:"Group"};v.__docgenInfo={description:"",methods:[],displayName:"OneOption"};h.__docgenInfo={description:"",methods:[],displayName:"Controlled"};C.__docgenInfo={description:"",methods:[],displayName:"InTable"};k.__docgenInfo={description:"",methods:[],displayName:"Conditional"};j.__docgenInfo={description:"",methods:[],displayName:"InTableWithPagination"};P.__docgenInfo={description:"",methods:[],displayName:"ContentEx1"};f.__docgenInfo={description:"",methods:[],displayName:"ContentEx2"};y.__docgenInfo={description:"",methods:[],displayName:"ContentEx3"};var _,R,N;x.parameters={...x.parameters,docs:{...(_=x.parameters)==null?void 0:_.docs,source:{originalSource:`{
  ...
  </Fieldset>`,...(Te=(ye=y.parameters)==null?void 0:ye.docs)==null?void 0:Te.source}}};const Je=["Preview","AriaLabel","Group","OneOption","WithError","Controlled","ReadOnly","Disabled","InTable","Conditional","InTableWithPagination","ContentEx1","ContentEx2","ContentEx3"];export{F as AriaLabel,k as Conditional,P as ContentEx1,f as ContentEx2,y as ContentEx3,h as Controlled,H as Disabled,d as Group,C as InTable,j as InTableWithPagination,v as OneOption,x as Preview,I as ReadOnly,S as WithError,Je as __namedExportsOrder,$e as default};
