import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{B as P,a9 as ue}from"./SlotDialog-CuE-xZdd.js";import{S as w}from"./styrbordDecorator-DUnsr90U.js";import{r as de}from"./iframe-DkgepJ9T.js";import"./Details-BNXegy-d.js";import"./translations-Nqk0a8n1.js";import"./kyvDivider-GkhM6YIE.js";import"./typography-CdiQYpGP.js";import"./skillingsbuoye-BG85ofhS.js";import"./Logo-DajRw6N7.js";import{c as ge,H as De}from"./tooltip-Q5XGAmIk.js";import"./index-OUpqSSdN.js";import"./index-CXCEydTa.js";import"./preload-helper-Dp1pzeXC.js";const fe=r=>{const[o,t]=de.useState(r.value),me=v=>{var y;t(v),(y=r.onChange)==null||y.call(r,v)};return e.jsx(ue,{...r,value:o,onChange:me})},Be={title:"Form/Datepicker",component:fe,decorators:[w,r=>e.jsx("div",{style:{margin:"0 auto",width:"fit-content"},children:e.jsx(r,{})})],tags:["autodocs","kyv"],argTypes:{}},a={label:"Datepicker",description:"Description",value:void 0,onChange:r=>console.log("onChange ",r)},n={args:a},s={args:{...a,showCalendarIcon:!1}},i={args:{...a,description:""}},l={args:{...a,value:new Date}},p={args:{...a,value:new Date,optional:!0}},c={args:{...a,value:new Date,optional:"Spesialtilpasset Verdi"}},d={args:{...a,value:new Date,required:!0}},m={args:{...a,value:new Date,error:"Error message"}},u={args:{...a,label:"Dato fra i dag",description:"Kun framtidige datoer kan velges",minDate:new Date}},g={args:{...a,label:"Dato til i dag",description:"Kun tidligere og dagens dato kan velges",maxDate:new Date}},D={args:{...a,label:"Velg dato innen 2 uker",description:"Du kan velge dato fra i dag og inntil 2 uker frem i tid",minDate:new Date,maxDate:new Date(Date.now()+336*60*60*1e3)}},f={args:{...a,label:"Plassering av popup",description:'Endre plassering av kalender-popup via "popperPlacement" prop',popperPlacement:"top"},argTypes:{popperPlacement:{control:{type:"select"},options:["top","bottom","left","right"]}},decorators:[w,r=>e.jsx("div",{style:{minHeight:"400px",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsx("div",{style:{},children:e.jsx(r,{})})})]},h={args:{...a,withPortal:!0},decorators:[w,r=>{const o=de.useRef(null);return e.jsxs(e.Fragment,{children:[e.jsx(P,{onClick:()=>{var t;return(t=o.current)==null?void 0:t.showModal()},children:"Åpne Dialog"}),e.jsxs(ge,{ref:o,style:{maxWidth:"400px",maxHeight:"200px"},children:[e.jsx(De,{style:{marginBottom:"16px"},children:"Dialog med Datepicker"}),e.jsx("div",{style:{marginBottom:"24px"},children:e.jsx(r,{})}),e.jsx(P,{variant:"filled",onClick:()=>{var t;return(t=o.current)==null?void 0:t.close()},children:"Lukk Dialog"})]})]})}]},x={args:{...a,showYearDropdown:!0,showMonthDropdown:!0,value:new Date,minDate:new Date(2015,1,1),maxDate:new Date,description:"Også begrenset med minDate og maxDate"}};var k,S,W;n.parameters={...n.parameters,docs:{...(k=n.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: defaultProps
...
}`,...(ie=(se=h.parameters)==null?void 0:se.docs)==null?void 0:ie.source}}};var le,pe,ce;x.parameters={...x.parameters,docs:{...(le=x.parameters)==null?void 0:le.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
...
}`,...(ce=(pe=x.parameters)==null?void 0:pe.docs)==null?void 0:ce.source}}};const Re=["Default","WithoutCalendarIcon","WithoutDescription","WithValue","Optional","OptionalText","Required","WithError","WithMinDate","WithMaxDate","WithMinAndMaxDate","PopperPlacement","InDialogNearEdge","WithYearAndMonthDropdown"];export{n as Default,h as InDialogNearEdge,p as Optional,c as OptionalText,f as PopperPlacement,d as Required,m as WithError,g as WithMaxDate,D as WithMinAndMaxDate,u as WithMinDate,l as WithValue,x as WithYearAndMonthDropdown,s as WithoutCalendarIcon,i as WithoutDescription,Re as __namedExportsOrder,Be as default};
