import{S as he,j as r,r as be}from"./iframe-tRSwKzMd.js";import{F as P,g as we,h as b,v as Se}from"./Dialog-CZ3oo3rE.js";import{c as j}from"./Cat 1-CDyACPiq.js";import{c as k}from"./Cat 2-CSvMt87v.js";import{p as Te}from"./Pikekyst Oppskrift-Mt2fCVYl.js";import"./preload-helper-Dp1pzeXC.js";import"./tooltip-_q7BVRen.js";import"./index-B9GFplko.js";import"./index-Bk76LeD0.js";import"./shipTypes-hFnSBndP.js";import"./Details-jtp_IHP_.js";import"./KyvDivider-DFwcKNrN.js";import"./typography-D8gUJzsN.js";import"./KyvSpinner-5-aYBCtr.js";import"./skillingsbuoye-B7g4mHO_.js";import"./Logo-BgXoLW5i.js";import"./color-tokens-BaFqaga0.js";const y=async()=>new Promise(e=>{setTimeout(()=>{e([{storageId:"1",thumbnailUri:j,previewUri:j,sizeInBytes:9281231},{storageId:"2",thumbnailUri:k,previewUri:k,sizeInBytes:192811},{storageId:"3",thumbnailUri:void 0,previewUri:Te,sizeInBytes:12122}])},1e3)}),je=e=>{const[a,i]=be.useState([...e.files]),h=S=>{var T;i(S),(T=e.onChange)==null||T.call(e,S)};return r.jsx(we,{...e,files:a,onChange:h})},Ge={title:"Form/FileUploader",component:je,decorators:[e=>r.jsx(P.Provider,{value:{deriveFileInfosFromStorageIds:y},children:r.jsx(e,{})}),he],tags:["autodocs","kyv","beta"],argTypes:{}},t={label:"Last opp filer",description:"Du kan laste opp flere filer samtidig",error:null,multiple:!0,files:[{fileName:"file1.txt",status:"uploaded",contentType:"text/plain",contextId:"214b3c2e-1f4d-4f8a-9b6c-5d7e8f9a0b1c",storageId:"1"},{fileName:"file2.txt",status:"uploaded",contentType:"text/plain",contextId:"214b3c2e-1f4d-4f3a-9b6c-5d7e8f9a0b1c",storageId:"1"},{fileName:"file3.jpeg",status:"uploaded",contentType:"image/jpeg",contextId:"214b3c2e-1f4d-4f8a-a127-5d7e8f9a0b1c",storageId:"1"}],maxFiles:5,maxSizeInBytes:10*1e3*1e3,onChange:e=>console.log("Files changed:",e),allowedFileTypes:[".pdf",".jpg",".jpeg",".png"]},Pe=async()=>(await new Promise(e=>setTimeout(e,1e3)),[{title:"Testfiler",label:"Dette er bare noen testfiler",files:[{contextId:"existing-1",fileName:"document1.pdf",storageId:"storage-id-1",contentType:"application/pdf",status:"uploaded"},{contextId:"existing-2",fileName:"image1.jpg",storageId:"storage-id-2",contentType:"image/jpeg",status:"uploaded"},{contextId:"existing-3",fileName:"screenshot.png",storageId:"1",contentType:"image/png",status:"uploaded"}]},{title:"Flere testfiler",label:"Abrakadabra, this page now has more testfiles",files:[{contextId:"existing-test2-1",fileName:"document1.pdf",storageId:"storage-id-test2-1",contentType:"application/pdf",status:"uploaded"},{contextId:"existing-test2-2",fileName:"image1.jpg",storageId:"2",contentType:"image/jpeg",status:"uploaded"},{contextId:"existing-test2-3",fileName:"aCoolDocument.pdf",storageId:"storage-id-test2-3",contentType:"application/pdf",status:"uploaded"},{contextId:"existing-test2-4",fileName:"screenshot.png",storageId:"3",contentType:"image/png",status:"uploaded"}]}]),s={args:t},o={args:{...t,optional:!0}},n={args:{...t,optional:"Spesialtilpasset Verdi"}},l={args:{...t,required:!0}},d={args:{...t,required:"Påkrevd"}},p={args:{...t,variant:"dropzone"}},c={args:{...t,variant:"dropzone",existingFilesProvider:Pe}},u={args:{...t,error:"Det oppstod en feil"}},m={args:{...t,description:"Capture button vises kun på mobilenheter",withCaptureButton:!0,files:[]}},g={args:{...t,files:[],existingFilesProvider:Pe}},ye=async e=>new Promise(a=>{const i=e.get("file"),h=10*1024*1024;setTimeout(()=>{i&&i.size>h?a({storageId:"",success:!1,error:"file-too-large"}):a({storageId:Se(),success:!0})},1500)}),w=async()=>new Promise(e=>{setTimeout(()=>{e()},1e3)}),f={decorators:[e=>r.jsx(b.Provider,{value:{uploadFile:ye,deleteFile:w},children:r.jsx(P.Provider,{value:{deriveFileInfosFromStorageIds:y},children:r.jsx(e,{})})})],args:{...t,description:"Filer som er større enn 10MB vil bli avvist",files:[]}},v={decorators:[e=>r.jsx(b.Provider,{value:{uploadFile:ye,deleteFile:w},children:r.jsx(P.Provider,{value:{deriveFileInfosFromStorageIds:y},children:r.jsx(e,{})})})],args:{...t,allowFilePreview:!0,description:"Filer som er større enn 10MB vil bli avvist",files:[{fileName:"cat1.jpg",status:"uploaded",contentType:"image/jpeg",contextId:"214b3c2e-1f4d-4f8a-9b6c-5d7e8f9xxb1c",storageId:"1"},{fileName:"cat2.jpg",status:"uploaded",contentType:"image/jpeg",contextId:"214b3c2e-1f4d-4f3a-9b6c-5d7e8fdsd0b1c",storageId:"2"},{fileName:"file3.pdf",status:"uploaded",contentType:"application/pdf",contextId:"214b3c2e-1f4d-4f8a-a127-5d7e8ffff1c",storageId:"3"}]}},x={args:{...t,allowedFileTypes:[".exe",".bat",".zip","image/*"],description:"Aksepterer kun filer med utvidelsene .exe, .bat, .zip og bildefiler",files:[]}},ke=async()=>new Promise(e=>{setTimeout(()=>{e({storageId:"",success:!1,error:"file-scan-failed"})},1500)}),F={decorators:[e=>r.jsx(b.Provider,{value:{uploadFile:ke,deleteFile:w},children:r.jsx(P.Provider,{value:{deriveFileInfosFromStorageIds:y},children:r.jsx(e,{})})})],args:{...t,description:"Opplastning av fil vil gi feil ved scanning av filen",files:[]}},I={args:{...t,allowFilePreview:!0,description:"Klikk på forhåndsvisningsknappen for å se filer i full størrelse",files:[{fileName:"Pikekyst Oppskrift.pdf",status:"uploaded",contentType:"application/pdf",contextId:"preview-pdf-1",storageId:"1"},{fileName:"file3.jpeg",status:"uploaded",contentType:"image/jpeg",contextId:"preview-img-1",storageId:"2"},{fileName:"file4.jpeg",status:"uploaded",contentType:"image/jpeg",contextId:"preview-img-2",storageId:"3"},{fileName:"readme.txt",status:"uploaded",contentType:"text/plain",contextId:"preview-txt-1",storageId:"4"}]}};var C,N,z;s.parameters={...s.parameters,docs:{...(C=s.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: defaultProps
}`,...(z=(N=s.parameters)==null?void 0:N.docs)==null?void 0:z.source}}};var W,U,B;o.parameters={...o.parameters,docs:{...(W=o.parameters)==null?void 0:W.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    optional: true
  }
...
}`,...(te=(ee=m.parameters)==null?void 0:ee.docs)==null?void 0:te.source}}};var re,ae,ie;g.parameters={...g.parameters,docs:{...(re=g.parameters)==null?void 0:re.docs,source:{originalSource:`{
  args: {
    ...defaultProps,
    files: [],
    existingFilesProvider: existingFilesProvider
  }
}`,...(ie=(ae=g.parameters)==null?void 0:ae.docs)==null?void 0:ie.source}}};var se,oe,ne;f.parameters={...f.parameters,docs:{...(se=f.parameters)==null?void 0:se.docs,source:{originalSource:`{
...
}`,...(Ie=(Fe=I.parameters)==null?void 0:Fe.docs)==null?void 0:Ie.source}}};const He=["Default","Optional","OptionalText","Required","RequiredText","Dropzone","DropzoneWithExistingFiles","WithError","WithCaptureButton","WithExistingFiles","withFileSizeLimit","withPreviews","withAllowedFileTypes","withFileScanFailed","WithFilePreview"];export{s as Default,p as Dropzone,c as DropzoneWithExistingFiles,o as Optional,n as OptionalText,l as Required,d as RequiredText,m as WithCaptureButton,u as WithError,g as WithExistingFiles,I as WithFilePreview,He as __namedExportsOrder,Ge as default,x as withAllowedFileTypes,F as withFileScanFailed,f as withFileSizeLimit,v as withPreviews};
