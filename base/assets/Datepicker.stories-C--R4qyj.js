import{j as r}from"./jsx-runtime-BjG_zV1W.js";import{m as pe,B as P,n as ce}from"./Card-iCNsRmt0.js";import{S as h}from"./styrbordDecorator-CuX9sRQT.js";import{r as ie}from"./index-BNURykns.js";import"./Details-DhircH7M.js";import"./kyvDivider-DSk0K4x1.js";import"./typography-9ubeq_Vx.js";import"./skillingsbuoye-mzpk6Jp8.js";import"./Logo-CEva0-QL.js";import{H as de}from"./heading-CSzZkkgN.js";import"./index-oiHgbqC6.js";import"./index-CE0WYpVZ.js";import"./lite-DaUVFjkg.js";import"./index-DVavdBNq.js";import"./label-CRl1GVLX.js";import"./index-LL6r61Qw.js";/* empty css                        */const me=e=>{const[o,t]=ie.useState(e.value),le=v=>{var y;t(v),(y=e.onChange)==null||y.call(e,v)};return r.jsx(pe,{...e,value:o,onChange:le})},Me={title:"Form/Datepicker",component:me,decorators:[h,e=>r.jsx(e,{})],tags:["autodocs","kyv"],argTypes:{}},a={label:"Datepicker",description:"Description",value:void 0,onChange:e=>console.log("onChange ",e)},s={args:a},n={args:{...a,showCalendarIcon:!1}},i={args:{...a,description:""}},l={args:{...a,value:new Date}},p={args:{...a,value:new Date,optional:!0}},c={args:{...a,value:new Date,optional:"Spesialtilpasset Verdi"}},d={args:{...a,value:new Date,required:!0}},m={args:{...a,value:new Date,error:"Error message"}},u={args:{...a,label:"Dato fra i dag",description:"Kun framtidige datoer kan velges",minDate:new Date}},g={args:{...a,label:"Dato til i dag",description:"Kun tidligere og dagens dato kan velges",maxDate:new Date}},D={args:{...a,label:"Velg dato innen 2 uker",description:"Du kan velge dato fra i dag og inntil 2 uker frem i tid",minDate:new Date,maxDate:new Date(Date.now()+14*24*60*60*1e3)}},f={args:{...a,label:"Plassering av popup",description:'Endre plassering av kalender-popup via "popperPlacement" prop',popperPlacement:"top"},argTypes:{popperPlacement:{control:{type:"select"},options:["top","bottom","left","right"]}},decorators:[h,e=>r.jsx("div",{style:{minHeight:"400px",display:"flex",alignItems:"center",justifyContent:"center"},children:r.jsx("div",{style:{},children:r.jsx(e,{})})})]},x={args:{...a,withPortal:!0},decorators:[h,e=>{const o=ie.useRef(null);return r.jsxs(r.Fragment,{children:[r.jsx(P,{onClick:()=>{var t;return(t=o.current)==null?void 0:t.showModal()},children:"Åpne Dialog"}),r.jsxs(ce,{ref:o,style:{maxWidth:"400px",maxHeight:"200px"},children:[r.jsx(de,{style:{marginBottom:"16px"},children:"Dialog med Datepicker"}),r.jsx("div",{style:{marginBottom:"24px"},children:r.jsx(e,{})}),r.jsx(P,{variant:"filled",onClick:()=>{var t;return(t=o.current)==null?void 0:t.close()},children:"Lukk Dialog"})]})]})}]};var k,w,S;s.parameters={...s.parameters,docs:{...(k=s.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: defaultProps
