import{S as L,j as i}from"./iframe-RURyLk5M.js";import{M as I,c as D,v as U}from"./Dialog-WcwNGnFw.js";import{a as K}from"./atlas 1-DK2KYHpu.js";import"./preload-helper-Dp1pzeXC.js";import"./tooltip-srqks4OZ.js";import"./index-DkpUIaZ9.js";import"./index-l_paPnZM.js";import"./Details-CLar5ZsU.js";import"./KyvDivider-BZgdx-hu.js";import"./typography-CqfE70Aw.js";import"./KyvSpinner-BjspyfAu.js";import"./skillingsbuoye-C84g7947.js";import"./Logo-BCxdJsuH.js";const re={title:"Components/MarkdownToReact",component:I,decorators:[L],tags:["autodocs","kyv","beta"],argTypes:{markdown:{control:"text"}}},P=async()=>new Promise(m=>{setTimeout(()=>{m([{storageId:"image://86062b3c-ebc8-48d0-9d08-8c282f5d8c69",previewUri:K}])},300)}),B=async()=>({storageId:U(),success:!0}),N=async()=>{},e={args:{markdown:"**MarkdownToReact** er en komponent som lar deg rendere markdown som React-komponenter."}},r={args:{markdown:`# Overskrift nivå 1
...
}`,...(b=(v=n.parameters)==null?void 0:v.docs)==null?void 0:b.source}}};var f,j,R;o.parameters={...o.parameters,docs:{...(f=o.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
...
}`,...(R=(j=o.parameters)==null?void 0:j.docs)==null?void 0:R.source}}};var F,T,y;s.parameters={...s.parameters,docs:{...(F=s.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
