import{j as e}from"./iframe-WKIRg0XG.js";import{d as a}from"./Dialog-D4qjwnD9.js";import"./shipTypes-hFnSBndP.js";import"./Details-CRHO2nlV.js";import"./KyvDivider-L4aYN3Mp.js";import"./typography-DVDzzXfp.js";import"./KyvSpinner-DMTidkHX.js";import"./skillingsbuoye-DkUwV7IG.js";import"./Logo-DF4wfcVh.js";import"./tooltip-Cb0cksK0.js";import"./preload-helper-Dp1pzeXC.js";import"./color-tokens-DRys5hYJ.js";import"./index-BprNiIUZ.js";import"./index-B46LPQkM.js";const fr={title:"Components/Tag",component:a,tags:["autodocs","ds"],parameters:{customStyles:{justifyContent:"start"},docs:{description:{component:"[Dokumentasjon fra Designsystemet](https://designsystemet.no/no/components/docs/tag/overview)"}}}},s=["accent","extra1","neutral","success","warning","danger","info"],g={args:{children:"New"}},ar=["sm","md","lg"],n=({...o})=>e.jsx(e.Fragment,{children:ar.map(r=>e.jsx(a,{"data-size":r,...o,children:r},r))});n.parameters={customStyles:{display:"flex",alignItems:"center",gap:"var(--ds-size-2)"}};const t=({...o})=>e.jsx(e.Fragment,{children:s.map(r=>e.jsx(a,{"data-color":r,...o,children:r},r))});t.parameters={customStyles:{display:"grid",gridTemplateColumns:"repeat(4, 1fr)",gap:"var(--ds-size-2)",height:"100%",width:"100%",placeItems:"center"}};const c=({...o})=>e.jsx(e.Fragment,{children:s.map(r=>e.jsx(a,{bordered:!0,"data-color":r,...o,children:r},r))});c.parameters={customStyles:{display:"grid",gridTemplateColumns:"repeat(4, 1fr)",gap:"var(--ds-size-2)",height:"100%",width:"100%",placeItems:"center"}};const l=({...o})=>e.jsx(e.Fragment,{children:s.map(r=>e.jsx(a,{rounded:!0,"data-color":r,...o,children:r},r))}),m=({...o})=>e.jsx(e.Fragment,{children:ar.map(r=>e.jsx(a,{rounded:!0,"data-size":r,...o,children:r},r))}),u=({...o})=>e.jsx(e.Fragment,{children:s.map(r=>e.jsx(a,{rounded:!0,bordered:!0,"data-color":r,...o,children:r},r))}),h={args:{children:"Status",icon:"check_circle"}},y={args:{children:"Status",plainBackground:!0}},S={args:{children:"Status",icon:"check_circle",plainBackground:!0,rounded:!0,"data-color":"accent"}},d=({...o})=>e.jsx(e.Fragment,{children:s.map(r=>e.jsx(a,{icon:"info","data-color":r,...o,children:r},r))});d.parameters={customStyles:{display:"flex",flexWrap:"wrap",gap:"var(--ds-size-2)"}};const i=({...o})=>e.jsx(e.Fragment,{children:s.map(r=>e.jsx(a,{rounded:!0,icon:"info",bordered:!0,"data-color":r,...o,children:r},r))});i.parameters={customStyles:{display:"flex",flexWrap:"wrap",gap:"var(--ds-size-2)"}};const p=({...o})=>e.jsx(e.Fragment,{children:s.map(r=>e.jsx(a,{rounded:!0,icon:"info",plainBackground:!0,"data-color":r,...o,children:r},r))});p.parameters={customStyles:{display:"flex",flexWrap:"wrap",gap:"var(--ds-size-2)"}};n.__docgenInfo={description:"",methods:[],displayName:"Sizes"};t.__docgenInfo={description:"",methods:[],displayName:"Colors"};c.__docgenInfo={description:"",methods:[],displayName:"Borders"};l.__docgenInfo={description:"",methods:[],displayName:"Rounded"};m.__docgenInfo={description:"",methods:[],displayName:"RoundedWithSizes"};u.__docgenInfo={description:"",methods:[],displayName:"RoundedWithBorders"};d.__docgenInfo={description:"",methods:[],displayName:"WithIconColors"};i.__docgenInfo={description:"",methods:[],displayName:"RoundedWithIconColors"};p.__docgenInfo={description:"",methods:[],displayName:"RoundedWithIconPlainColors"};var f,x,T;g.parameters={...g.parameters,docs:{...(f=g.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    children: 'New'
  }
}`,...(T=(x=g.parameters)==null?void 0:x.docs)==null?void 0:T.source}}};var I,_,k;n.parameters={...n.parameters,docs:{...(I=n.parameters)==null?void 0:I.docs,source:{originalSource:`({
  ...rest
}) => {
  return <>
...
}`,...(C=(B=c.parameters)==null?void 0:B.docs)==null?void 0:C.source}}};var P,w,N;l.parameters={...l.parameters,docs:{...(P=l.parameters)==null?void 0:P.docs,source:{originalSource:`({
  ...rest
}) => {
  return <>
...
}`,...(N=(w=l.parameters)==null?void 0:w.docs)==null?void 0:N.source}}};var v,F,V;m.parameters={...m.parameters,docs:{...(v=m.parameters)==null?void 0:v.docs,source:{originalSource:`({
  ...rest
}) => {
  return <>
...
}`,...($=(Z=i.parameters)==null?void 0:Z.docs)==null?void 0:$.source}}};var rr,er,or;p.parameters={...p.parameters,docs:{...(rr=p.parameters)==null?void 0:rr.docs,source:{originalSource:`({
  ...rest
}) => {
  return <>
...
}`,...(or=(er=p.parameters)==null?void 0:er.docs)==null?void 0:or.source}}};const xr=["Preview","Sizes","Colors","Borders","Rounded","RoundedWithSizes","RoundedWithBorders","WithIcon","PlainBackground","PlainBackgroundRoundedWithIcon","WithIconColors","RoundedWithIconColors","RoundedWithIconPlainColors"];export{c as Borders,t as Colors,y as PlainBackground,S as PlainBackgroundRoundedWithIcon,g as Preview,l as Rounded,u as RoundedWithBorders,i as RoundedWithIconColors,p as RoundedWithIconPlainColors,m as RoundedWithSizes,n as Sizes,h as WithIcon,d as WithIconColors,xr as __namedExportsOrder,fr as default};
