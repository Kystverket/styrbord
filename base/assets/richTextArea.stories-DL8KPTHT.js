import{S as T,j as t,r as u}from"./iframe-CCe_dCCr.js";import{R as p,d as j,F as D,v as P}from"./Dialog-UXwq2wM8.js";import{a as B}from"./atlas 1-DK2KYHpu.js";import"./preload-helper-Dp1pzeXC.js";import"./tooltip-BYKdyOlq.js";import"./index-DFWOv3TC.js";import"./index-D6INI_Eg.js";import"./Details-CAHUgFkq.js";import"./KyvDivider-HRHuqgBx.js";import"./typography-SIsVzqlb.js";import"./KyvSpinner-BWw3or9j.js";import"./skillingsbuoye-BtcJADm-.js";import"./Logo-D1-psF0u.js";const X={title:"Form/RichTextArea/RichTextArea",component:p,decorators:[e=>t.jsx(D.Provider,{value:{deriveFileInfosFromStorageIds:A},children:t.jsx(e,{})}),T],tags:["autodocs","kyv","beta"]},O=e=>new Promise((n,a)=>{const r=new FileReader;r.onload=()=>{if(typeof r.result=="string"){n(r.result);return}a(new Error("Could not read image file"))},r.onerror=()=>a(r.error??new Error("Could not read image file")),r.readAsDataURL(e)}),c={value:"",onChange:()=>{},label:"Rikt tekstfelt",description:"Dette er et tekstfelt som støtter rik tekstformatering.",optional:"Valgfritt"},A=async()=>new Promise(e=>{setTimeout(()=>{e([{storageId:"image://86062b3c-ebc8-48d0-9d08-8c282f5d8c69",previewUri:B}])},1e3)}),E=async()=>new Promise(e=>{setTimeout(()=>{e({storageId:P(),success:!0})},1500)}),L=async()=>new Promise(e=>{setTimeout(()=>{e()},1e3)}),g=e=>{const n=()=>{const[a,r]=u.useState(e.value??"");return t.jsx(p,{...e,value:a,onChange:o=>{r(o),console.log("RichTextArea markdown:",o),e.onChange(o)}})};return t.jsx(n,{})},i={args:c,render:g},d={args:{...c,disabled:!0,value:"Skrivebeskyttet innhold"},render:g},l={args:{...c,error:"Du må fylle ut dette feltet."},render:g},s={args:{...c,value:`
Bilde av Atlas
![Bilde_av_atlas.png](image://86062b3c-ebc8-48d0-9d08-8c282f5d8c69)`,label:"Rikt tekstfelt med bildereferanse",description:"Last opp et bilde — markdownutdata vil inneholde en stabil referanse til bildet.",onImageUpload:async e=>{const n=await O(e),a=`image://${crypto.randomUUID()}`;return{src:n,ref:a,alt:e.name}},onImageRemove:async e=>{alert("Removed image "+e)}},render:e=>{const[n,a]=u.useState(e.value??""),[r,o]=u.useState("");return t.jsx(j.Provider,{value:{uploadFile:E,deleteFile:L},children:t.jsxs(D.Provider,{value:{deriveFileInfosFromStorageIds:A},children:[t.jsx(p,{...e,value:n,onChange:m=>{a(m),o(m),e.onChange(m)}}),r&&t.jsxs("div",{style:{marginTop:"12px"},children:[t.jsx("p",{style:{marginBottom:"0.25rem",fontWeight:"bold",fontSize:"0.875rem"},children:"Markdown sendt til onChange:"}),t.jsx("pre",{style:{background:"#f4f4f4",border:"1px solid #ddd",borderRadius:"4px",padding:"0.75rem",fontSize:"0.8rem",whiteSpace:"pre-wrap",wordBreak:"break-all"},children:r})]})]})})}};var f,v,h;i.parameters={...i.parameters,docs:{...(f=i.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: defaultArgs,
