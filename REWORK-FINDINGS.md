...
> deviated from the original proposal. Everything in steps 2–6 is still open. Sections 1.6, 1.7 and
> the relevant parts of 1.5 and 2.7 describe the state *before* those fixes and are kept as the
