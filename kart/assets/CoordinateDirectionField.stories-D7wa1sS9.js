import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as S}from"./iframe-CUoqqlLx.js";import{S as V}from"./MapCenterAction-BxPsKFQt.js";import{C as l}from"./CoordinateDirectionField-C-oO2IXb.js";import"./preload-helper-Dp1pzeXC.js";import"./style-nzlqOepm.js";import"./index-DBtCTHGO.js";import"./index-BZztosZC.js";import"./GeoJsonEditor-BsdIVax1.js";const z={title:"Kart/CoordinateDirectionField",component:l,decorators:[V],tags:["autodocs","kyv"],parameters:{layout:"padded",docs:{story:{inline:!1,iframeHeight:"600px"}}}},d=r=>{const{initialValue:i,...j}=r,[P,D]=S.useState(i);return e.jsx(l,{value:P,onChange:D,...j})},s=()=>{},n={args:{value:void 0,onChange:s},render:()=>e.jsx(d,{label:"Plassering og retning"})},k=()=>{const[r,i]=S.useState({type:"Feature",geometry:{type:"Point",coordinates:[10.3951,63.4305]},properties:{direction:45}});return e.jsxs("div",{style:{maxWidth:700},children:[e.jsx(l,{label:"Skiltplassering",value:r,onChange:i}),e.jsx("pre",{style:{marginTop:16,fontSize:12,background:"#f5f5f5",padding:12,borderRadius:4},children:JSON.stringify(r,null,2)})]})},o={args:{value:void 0,onChange:s},render:()=>e.jsx(k,{})},a={args:{value:void 0,onChange:s},render:()=>e.jsx(d,{label:"Plassering og retning",error:"Koordinat er påkrevd"})},t={args:{value:void 0,onChange:s},render:()=>e.jsx(d,{label:"Plassering og retning",initialValue:{type:"Feature",geometry:{type:"Point",coordinates:[10.3951,63.4305]},properties:{direction:45}},disabled:!0})};var p,c,g;n.parameters={...n.parameters,docs:{...(p=n.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
    value: undefined,
    onChange: noop
  },
