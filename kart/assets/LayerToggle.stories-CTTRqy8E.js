...
}`,...(u=(p=r.parameters)==null?void 0:p.docs)==null?void 0:u.source},description:{story:"Default — collapsed, with built-in layers available.",...(v=(y=r.parameters)==null?void 0:y.docs)==null?void 0:v.description}}};var m,h,L,k,P;t.parameters={...t.parameters,docs:{...(m=t.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: () => <ViewBoundsProvider>
      <BaseLayersProvider>
...
}`,...(f=(j=s.parameters)==null?void 0:j.docs)==null?void 0:f.source},description:{story:"Multiple base layers — demonstrates the radio-button base layer switcher.",...(R=(A=s.parameters)==null?void 0:A.docs)==null?void 0:R.description}}};const Z=["Default","StartOpen","FilteredLayers","MultipleBaseLayers"];export{r as Default,a as FilteredLayers,s as MultipleBaseLayers,t as StartOpen,Z as __namedExportsOrder,X as default};
