  ...
  return {
    ...
    sources: {
      [sourceId]: {
        ...
        tileSize: 256,
        attribution: attribution ?? `&copy; <a href="${new URL(baseUrl).origin}">${new URL(baseUrl).hostname}</a>`,
      },
    },
    layers: [
      {
...
export const BUILT_IN_LAYERS: LayerDefinition[] = [
  ...
  kystverketWms('Beredskapsanalyseomrader', 'Beredskapsanalyseområder', 'layer_764', 'Beredskap'),
  kystverketWms('Nodhavner', 'Nødhavner', 'layer_26', 'Beredskap'),
  kystverketWms('Iua', 'IUA', 'layer_493', 'Beredskap'),
  kystverketWms('RitsKjemikalieberedskap', 'RITS - kjemikalieberedskap', 'layer_220', 'Beredskap'),
  ...
  kystverketWms('100MeterBuffer', '100 meter buffer', 'layer_584', 'Buffersoner'),

  // --- Data fra Sjøfartsdirektoratet ---
  kystverketWms('Fartsomrade1', 'Fartsområde 1', 'layer_959', 'Data fra Sjøfartsdirektoratet'),
  kystverketWms('Fartsomrade2', 'Fartsområde 2', 'layer_960', 'Data fra Sjøfartsdirektoratet'),
  kystverketWms('Fartsomrade3', 'Fartsområde 3', 'layer_961', 'Data fra Sjøfartsdirektoratet'),
  kystverketWms('Fartsomrade4', 'Fartsområde 4', 'layer_962', 'Data fra Sjøfartsdirektoratet'),
  kystverketWms('LitenKystfart', 'Liten kystfart', 'layer_963', 'Data fra Sjøfartsdirektoratet'),
  kystverketWms(
  ...
  kystverketWms('FyreiendommerNy', 'Fyreiendommer (ny)', 'layer_512', 'Eiendom'),
  kystverketWms('FyreiendommerI3d', 'Fyreiendommer i 3d', 'layer_901', 'Eiendom'),

  // --- Fareområder ---
  kystverketWms('FareomraderAndoyaSpaceCenter', 'Fareområder Andøya Space center', 'layer_digi_87', 'Fareområder'),

  // --- Farled og merker ---
  kystverketWms('Farledsareal', 'Farledsareal', 'layer_554', 'Farled og merker'),
  ...
  kystverketWms('FartsrestriksjonerInnsjoOgElver', 'Fartsrestriksjoner innsjø og elver', 'layer_548', 'Fartsforskrift'),
  kystverketWms('Kommuneoversikt', 'Kommuneoversikt', 'layer_787', 'Fartsforskrift'),

  // --- Fiskeri og havbruk ---
  kystverketWms('AkvakulturanleggMedInnehaver', 'Akvakulturanlegg med innehaver', 'layer_775', 'Fiskeri og havbruk'),
  kystverketWms('HavbrukTilHavsTilrading2019', 'Havbruk til havs - Tilråding 2019', 'layer_589', 'Fiskeri og havbruk'),
  kystverketWms(
  ...
  kystverketWms('HavbrukTilHavsAnbefaling2022', 'Havbruk til havs anbefaling 2022', 'layer_885', 'Fiskeri og havbruk'),

  // --- Grenser og inndelinger ---
  kystverketWms('Verdensarvomrader', 'Verdensarvområder', 'layer_996', 'Grenser og inndelinger'),
  kystverketWms('Kommunegrenser', 'Kommunegrenser', 'layer_555', 'Grenser og inndelinger'),
  kystverketWms('Fylkesgrenser', 'Fylkesgrenser', 'layer_556', 'Grenser og inndelinger'),
  kystverketWms(
  ...
  kystverketWms('EcaOmrader', 'ECA områder', 'layer_557', 'Grenser og inndelinger'),
  kystverketWms('RedningsomradeNord', 'Redningsområde nord', 'layer_725', 'Grenser og inndelinger'),
  kystverketWms('RedningsomradeSor', 'Redningsområde Sør', 'layer_724', 'Grenser og inndelinger'),
  kystverketWms('Politidistrikt', 'Politidistrikt', 'layer_621', 'Grenser og inndelinger'),
  kystverketWms('Grense250Nm', 'Grense 250 nm', 'layer_786', 'Grenser og inndelinger'),
  ...
  kystverketWms('SikkerLastingLossingBulkskip', 'Sikker lasting/lossing bulkskip', 'layer_1049', 'Havn'),
  kystverketWms('BunkringAvDrivstoff', 'Bunkring av drivstoff', 'layer_digi_65', 'Havn'),
  kystverketWms('TenTHavnerINorge', 'Ten-T havner i Norge', 'layer_993', 'Havn'),
  kystverketWms('AisAnlopspunkter2023', 'AIS Anløpspunkter 2023', 'layer_1027', 'Havn'),
  kystverketWms('AisAnlopspolygoner2023', 'AIS anløpspolygoner 2023', 'layer_1028', 'Havn'),

  // --- Havvind ---
  kystverketWms('HavvindApnedeOmrader', 'Havvind - åpnede områder', 'layer_882', 'Havvind'),

  // --- Kystkontur (inkl. konstruert kystkontur) ---
  kystverketWms('Kystkontur', 'Kystkontur', 'layer_611', 'Kystkontur'),
  kystverketWms('BygningsmessigAnleggVann', 'Bygningsmessig anlegg (vann)', 'layer_612', 'Kystkontur'),
  ...
  // --- LNG omlasting ---
  kystverketWms('PosisjonerForLngOpplasting', 'Posisjoner for LNG opplasting', 'layer_521', 'LNG omlasting'),
  kystverketWms(
  ...
  kystverketWms('LadeanleggFerjer', 'Ladeanlegg ferjer', 'layer_709', 'Lavutslipp'),
  ...
  kystverketWms('LosstasjonerOgLosformidling', 'Losstasjoner og losformidling', 'layer_59', 'Los og farledsbevis'),
  kystverketWms('Losbordingsfelt', 'Losbordingsfelt', 'layer_29', 'Los og farledsbevis'),
  kystverketWms(
  ...
  kystverketWms('Losoldermannskap', 'Losoldermannskap', 'layer_534', 'Los og farledsbevis'),
  kystverketWms('FarledsbevisRutenett', 'Farledsbevis, rutenett', 'layer_341', 'Los og farledsbevis'),
  kystverketWms(
  ...
  kystverketWms('FdvLos2025', '2025 - FDV LOS', 'layer_1079', 'Los og farledsbevis'),

  // --- Maritim sikring ---
  kystverketWms('HovedOgBiled', 'Hoved- og biled', 'layer_552', 'Maritim sikring'),
  kystverketWms('IspsHavneanleggSsn', 'ISPS havneanlegg (SSN)', 'layer_420', 'Maritim sikring'),
  ...
  kystverketWms('OpplagsomraderForSjotransporten', 'Opplagsområder for sjøtransporten', 'layer_889', 'Maritim sikring'),
  kystverketWms('RiggomraderISjo', 'Riggområder i sjø', 'layer_890', 'Maritim sikring'),

  // --- Meteorologiske data ---
  kystverketWms('VaerdataFraKystvaer', 'Værdata fra Kystvær', 'layer_1129', 'Meteorologiske data'),
  ...
  kystverketWms('VtsTjenesteomrade', 'VTS tjenesteområde', 'layer_696', 'Rutetiltak, rapportering og VTS'),
  kystverketWms('Aktsomhetsomrader', 'Aktsomhetsområder', 'layer_102', 'Rutetiltak, rapportering og VTS'),
  kystverketWms('Toveisfarled', 'Toveisfarled', 'layer_104', 'Rutetiltak, rapportering og VTS'),
  kystverketWms('AnbefalteRuter', 'Anbefalte ruter', 'layer_702', 'Rutetiltak, rapportering og VTS'),
  kystverketWms('TssOmrader', 'TSS områder', 'layer_706', 'Rutetiltak, rapportering og VTS'),
  kystverketWms('TssAvgrensing', 'TSS avgrensing', 'layer_703', 'Rutetiltak, rapportering og VTS'),
  kystverketWms(
  ...
  // --- Sjøsikkerhet ---
  kystverketWms('Sjoulykker20092021', 'Sjøulykker 2009-2021', 'layer_799', 'Sjøsikkerhet'),
  externalWms(
  ...
  kystverketWms('VardoTrafikksentral', 'Vardø trafikksentral', 'layer_426', 'Sjøtrafikksentraltjenestens hendelser'),
  kystverketWms(
  ...
  // --- Skråfoto ---
  kystverketWms('SkrafotoAustAgder2008', 'Skråfoto - Aust-Agder - 2008', 'layer_215', 'Skråfoto'),
  kystverketWms('SkrafotoTroms2008', 'Skråfoto - Troms - 2008', 'layer_217', 'Skråfoto'),
  kystverketWms('SkrafotoTroms2005', 'Skråfoto - Troms - 2005', 'layer_218', 'Skråfoto'),
